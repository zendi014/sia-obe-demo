                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="index" id="topnav-dashboard" role="button">
                            <i data-feather="home"></i><span data-key="t-dashboards">@lang('translation.Dashboard')</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                            ...
                            <span data-key="t-components">@lang('translation.Elements')</span> 
                        ...
                        <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                            <div class="ps-2 p-lg-0">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div>
                                            <div class="menu-title">@lang('translation.Components')</div>
                                            <div class="row g-0">
                                                <div class="col-lg-5">
                                                    <div>
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        ...
                                                        <a href="ui-tabs-accordions" class="dropdown-item" data-key="t-tabs-accordions">@lang('translation.Tabs_n_Accordions')</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    <a href="apps-invoices-list" class="dropdown-item" data-key="t-invoice-list">@lang('translation.Invoice_List')</a>
                                    <a href="apps-invoices-detail" class="dropdown-item" data-key="t-invoice-detail">@lang('translation.Invoice_Detail')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    ...
                                    <a href="tables-datatable" class="dropdown-item" data-key="t-data-tables">@lang('translation.DataTables')</a>
                                    <a href="tables-responsive" class="dropdown-item" data-key="t-responsive-table">@lang('translation.Responsive')</a>
                                    <a href="tables-editable" class="dropdown-item" data-key="t-editable-table">@lang('translation.Editable')</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="charts-apex" class="dropdown-item" data-key="t-apex-charts">@lang('translation.Apexcharts')</a>
                                    <a href="charts-echart" class="dropdown-item" data-key="t-e-charts">@lang('translation.Echarts')</a>
